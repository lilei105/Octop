...
class ErrorCode(StrEnum):
    ...
    BIO_SCRIPT_NOT_FOUND = "BIO_SCRIPT_NOT_FOUND"
    BIO_SCRIPT_FOLDER_NOT_FOUND = "BIO_SCRIPT_FOLDER_NOT_FOUND"
    BIO_SCRIPT_FOLDER_NOT_EMPTY = "BIO_SCRIPT_FOLDER_NOT_EMPTY"
    BIO_SCRIPT_UNAVAILABLE = "BIO_SCRIPT_UNAVAILABLE"
    BIO_TASK_NOT_FOUND = "BIO_TASK_NOT_FOUND"
    BIO_TASK_STATE_INVALID = "BIO_TASK_STATE_INVALID"
    BIO_TASK_ACTIVE_EXISTS = "BIO_TASK_ACTIVE_EXISTS"
    BIO_FILE_SLOT_MISMATCH = "BIO_FILE_SLOT_MISMATCH"
    BIO_EXECUTION_UNSUPPORTED = "BIO_EXECUTION_UNSUPPORTED"
    BIO_IMPORT_EMPTY = "BIO_IMPORT_EMPTY"
...
_DEFAULT_STATUS: dict[ErrorCode, int] = {
    ...
    ErrorCode.BIO_SCRIPT_NOT_FOUND: 404,
    ErrorCode.BIO_SCRIPT_FOLDER_NOT_FOUND: 404,
    ErrorCode.BIO_SCRIPT_FOLDER_NOT_EMPTY: 409,
    ErrorCode.BIO_SCRIPT_UNAVAILABLE: 400,
    ErrorCode.BIO_TASK_NOT_FOUND: 404,
    ErrorCode.BIO_TASK_STATE_INVALID: 409,
    ErrorCode.BIO_TASK_ACTIVE_EXISTS: 409,
    ErrorCode.BIO_FILE_SLOT_MISMATCH: 400,
    ErrorCode.BIO_EXECUTION_UNSUPPORTED: 400,
    ErrorCode.BIO_IMPORT_EMPTY: 400,
}
